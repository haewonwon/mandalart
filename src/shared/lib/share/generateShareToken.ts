/**
 * 만다라트 공유 토큰 생성
 * @param mandalartId - 공유할 만다라트 ID
 * @returns Base64 인코딩된 공유 토큰
 * @description 만다라트 ID와 타임스탬프를 조합하여 URL-safe Base64 토큰 생성
 */
...
/**
 * 공유 토큰에서 만다라트 ID 추출
 * @param token - 공유 토큰 문자열
 * @returns 만다라트 ID 또는 null (파싱 실패 시)
 * @description Base64 디코딩하여 토큰에서 만다라트 ID 추출
 */
