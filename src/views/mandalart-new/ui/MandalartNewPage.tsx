...
export const MandalartNewPage = () => {
  ...
  return (
    <main className="flex flex-1 flex-col items-center bg-white px-4 py-12 sm:px-8">
      <section className="w-full max-w-4xl space-y-8">
        <header className="mb-6 space-y-2 text-center sm:text-left">
          ...
          <h1 className="text-3xl font-semibold text-slate-900 sm:text-4xl">새 만다라트 만들기</h1>
