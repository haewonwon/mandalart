...
export default function LoginPage() {
  return (
    <main className="flex flex-1 items-center justify-center bg-slate-50 px-6 py-12">
      <section className="flex w-full max-w-3xl flex-col gap-10 border border-slate-200 bg-white px-10 py-12">
        <div className="space-y-5 text-center">
          ...
          <div className="flex justify-center w-full">
            <ul className="w-fit list-disc list-inside space-y-2 text-sm text-slate-500 text-left">
        ...
        <div className="border border-slate-100 bg-slate-50/60 px-6 py-8">
          <GoogleLoginButton />
